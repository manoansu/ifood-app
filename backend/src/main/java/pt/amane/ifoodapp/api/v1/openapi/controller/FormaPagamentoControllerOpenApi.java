...
import pt.amane.ifoodapp.api.v1.openapi.model.FormasPagamentoModelOpenApi;

@Api(tags = "Formas de pagamento")
public interface FormaPagamentoControllerOpenApi {

	@ApiOperation(value = "Lista as formas de pagamento", response = FormasPagamentoModelOpenApi.class)
	ResponseEntity<CollectionModel<FormaPagamentoModelDTO>> listar(ServletWebRequest request);
	...
	ResponseEntity<FormaPagamentoModelDTO> buscar(
	...
	FormaPagamentoModelDTO adicionar(
	...
	FormaPagamentoModelDTO atualizar(
			@ApiParam(value = "ID de uma forma de pagamento", example = "1", required = true)
			Long formaPagamentoId,
